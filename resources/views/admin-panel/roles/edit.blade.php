    ...
    <div class="w-75">
        <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Edit roles page</span>
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <x-forms.form class="d-flex flex-column" method="post" action="{{route('roles.update',$role)}}">
                @csrf
                @method('PATCH')
                <x-forms.input label="Name" value="{{$role->name}}" type="text" name="name"
